...
import AddApplication from '../subComponents/AddSoftware.jsx';
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link className={`flex h-9 w-9 items-center justify-center rounded-lg 
                    ${active === "Dashboard" ? "text-accent-foreground bg-accent" 
            ...
            <Sheet>
              ...
              <SheetContent side="left" className='sm:max-w-xs' >
                <nav className='grid gap-6 text-lg font-medium'>
                  <Link className='group flex h-10 w-10 shrink-0 items-center justify-center gap-2
