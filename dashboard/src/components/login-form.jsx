...
export function LoginForm({
  ...
  return (
    (
    <form className={cn("flex flex-col gap-8", className)} {...props} onSubmit={handleLogin}>
      ...
      <div className="grid gap-6">
        ...
        <div className="grid gap-2">
          <div className="flex items-center">
            ...
            <Link to={"/password/forgot"} className="ml-auto text-sm underline-offset-4 hover:underline">
      ...
      {/* <div className="text-center text-sm">
        ...
        <a href="/password/forgot" className="underline underline-offset-4">
          Sign up
        </a>
      </div> */}
    </form>)
